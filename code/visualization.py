...
# 躯干参考范围已转换为垂直夹角 (180°=直立, 前倾越大角度越小)
STANDARD_REFERENCE_ANGLES = {
    "深蹲":   {"knee": (75, 170), "hip": (70, 170), "trunk": (145, 170)},
    "俯卧撑": {"elbow": (75, 170), "shoulder": (50, 130), "trunk": (160, 175)},
    "平板支撑": {"elbow": (85, 95), "hip": (170, 180), "trunk": (168, 180)},
    "卷腹":   {"trunk": (140, 175), "hip": (80, 120), "knee": (60, 90)},
    "开合跳": {"elbow": (30, 170), "knee": (20, 170), "trunk": (155, 180)},
    "引体向上": {"elbow": (40, 170), "shoulder": (30, 170), "trunk": (165, 180)},
    "臀桥":   {"hip": (85, 175), "knee": (60, 140), "trunk": (160, 180)},
    "高抬腿": {"hip": (75, 170), "knee": (65, 170), "trunk": (165, 180)},
    "肩推":   {"elbow": (55, 170), "shoulder": (40, 170), "trunk": (165, 180)},
    "侧平举": {"shoulder": (5, 95), "elbow": (140, 175), "trunk": (168, 180)},
}
